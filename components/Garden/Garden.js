    ...
    const pins = [
      {
        ...
        featuredImage: "/natural-stone-pathway.png", // Add featured image path
        badge: null,
        slug: "garden-pathway-designs",
      },
      /*
      {
        id: 4,
  ...
  return (
    <div className={styles.pinterestContainer}>
      <div className={styles.boardHeader}>
        <h1 className={styles.boardTitle}>🌿 Garden Design & Outdoor Living</h1>
        <p className={styles.boardDescription}>
          Transform your outdoor spaces into stunning gardens and inviting
          living areas. From pathway designs to patio decor, find inspiration to
      ...
      <div className={styles.pinsGrid}>
        {filteredPins.map((pin) => (
          <div key={pin.id} className={styles.pin}>
            <Link href={`/garden/${pin.slug}`} className={styles.pinLink}>
