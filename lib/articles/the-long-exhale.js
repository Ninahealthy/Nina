const article = {
  ...
  lead: "The exhale is not just the second half of a breath. It is a signal the vagus nerve sends to the brain that says: the danger has passed. You are allowed to land.",
  contentNote: null,
  ...
  citations: [
    { name: "Pranayama tradition", work: "Vedic breathwork lineage", type: "Tradition" },
  ],
  content: [
