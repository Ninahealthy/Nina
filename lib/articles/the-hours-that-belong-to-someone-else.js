const article = {
  ...
  relatedSlugs: ["the-warmth-that-stays", "the-hours-no-one-sees"],
  hookType: "confession",
  emotionalRegister: "acceptance",
  voiceMode: "raw",
  structureType: "classic-arc",
  citations: [
    { name: "Charles Figley", work: "Compassion Fatigue", type: "Book", citationMode: "agreement" },
  ],
  pinterestTitle: "When Caregiving Takes All Your Hours",
  pinterestDescription: null,
  ogImage: null,
  content: [
    { type: "paragraph", text: "I did not become a caregiver. I became one in the way you become tired: gradually, and then all at once. One week I was visiting my mother on Sundays, bringing flowers and a bag of groceries. The next I was managing her medications, driving her to appointments, sitting in waiting rooms with a book I never opened because I was listening for her name to be called. The week after that I had a key to her place and a column in my calendar that said Mom that stretched from Monday to Friday with no end date." },
