const article = {
  ...
  lead: "She left the room three minutes ago, and the cushion where she sat is still warm. I put my hand on it, and something in my chest responds before my mind does.",
  contentNote: null,
  tags: ["physical warmth", "body awareness", "attachment", "sensory connection"],
  relatedSlugs: ["the-practice-of-receiving", "the-hours-no-one-sees", "the-art-of-gentle-transitions"],
  hookType: "scene",
  ...
  ogImage: null,
  content: [
    { type: "paragraph", text: "She left the room three minutes ago, and the cushion where she sat is warm. I put my hand on it, and something in my chest responds before my mind does. A kind of recognition. Not of her, exactly, but of the fact that a body was here, in this specific spot, and the evidence has not yet disappeared." },
