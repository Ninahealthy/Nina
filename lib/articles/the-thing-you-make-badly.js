const article = {
  ...
  relatedSlugs: ["the-age-you-started-believing-you-were-too-late", "the-hours-no-one-sees"],
  hookType: "scene",
  emotionalRegister: "joy",
  voiceMode: "playful",
  structureType: "classic-arc",
  citations: [
    { name: "D.W. Winnicott", work: "Playing and Reality", type: "Book", citationMode: "agreement" },
    { name: "Mihaly Csikszentmihalyi", work: "Flow: The Psychology of Optimal Experience", type: "Book", citationMode: "unresolved-tension" },
  ],
  pinterestTitle: "Why Making Things Badly Is Good for You",
