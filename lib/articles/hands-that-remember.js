const article = {
  ...
  citations: [
    { name: "Kelly Lambert", work: "Lifting Depression", type: "Book" },
  ],
  content: [
    ...
    { type: "paragraph", text: "These are not trivial skills. They are a physical archive of your life, stored in the body rather than the mind. Every hand memory carries a context: the person who taught you, the kitchen where you learned, the afternoon light slanting across the counter and the smell of whatever was cooking. The hands remember the whole scene, not just the motion." },
    ...
    { type: "paragraph", text: "The remedy is not dramatic. It is a return to what the hands already know." },
