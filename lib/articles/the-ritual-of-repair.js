const article = {
  ...
  lead: "We live in a culture that replaces what is broken. But some things were meant to be mended, and the mending, the steady hands, the slow adhesive, is where the beauty lives.",
  contentNote: null,
  ...
  citations: [
    { name: "Kintsugi", work: "Japanese wabi-sabi tradition of golden repair", type: "Tradition" },
  ],
  content: [
