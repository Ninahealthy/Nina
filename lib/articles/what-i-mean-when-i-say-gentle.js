const article = {
  ...
  citations: [
    { name: "Kristin Neff", work: "Self-Compassion: The Proven Power of Being Kind to Yourself", type: "Book", citationMode: "evolving-understanding" },
  ],
  pinterestTitle: "Why Gentleness Takes More Strength Than Toughness",
  ...
  content: [
    ...
    { type: "paragraph", text: "None of these will change your life in a single morning. Wellness culture promises transformation; this is closer to maintenance. The daily practice of refusing to be your own adversary, and some days that practice fails, and on those days, the practice is being gentle about the failure to be gentle." },
